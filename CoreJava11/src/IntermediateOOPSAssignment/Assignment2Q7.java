...
public class Assignment2Q7 {
    ...
    private void addItems() {
    	System.out.println("Choose the Item to add to the storage");
    ...
    private void addItemsOperation(int choice) {
    	...
    	case 1:
    		...
    		System.out.println("Enter the amount of candies added :");
    		int need = sc.nextInt();
    	...
    	case 2:
    		...
    		System.out.println("Enter the amount of cookies added :");
    	...
    	case 3:
    		...
    		System.out.println("Enter the amount of IceCreames added :");
