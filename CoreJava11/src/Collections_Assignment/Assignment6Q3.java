...
public class Assignment6Q3 {
	...
	private void select() {
		...
		if (a == 1) {
			...
			Employee e1 = new Employee(10454, "Hema", "ECE",500);
			Employee e2 = new Employee(15545, "Mahe", "ece", 400);
			Employee e3 = new Employee(12232, "madu", "cse", 300);
			Employee e4 = new Employee(11323, "hema", "eee", 200);
			t1.add(e1);
			t1.add(e2);
			t1.add(e3);
			t1.add(e4);
			...
			Employee1 e1 = new Employee1(10454, "Hema", "ECE",500);
			Employee1 e2 = new Employee1(15545, "Mahe", "ece", 400);
			Employee1 e3 = new Employee1(12232, "madu", "cse", 300);
			Employee1 e4 = new Employee1(11323, "hema", "eee", 200);
			t2.add(e1);
			t2.add(e2);
			t2.add(e3);
			t2.add(e4);
			...
			Employee2 e1 = new Employee2(10454, "Hema", "ECE",500);
			Employee2 e2 = new Employee2(15545, "Mahe", "ece", 400);
			Employee2 e3 = new Employee2(12232, "madu", "cse", 300);
			Employee2 e4 = new Employee2(11323, "hema", "eee", 200);
			t3.add(e1);
			t3.add(e2);
			t3.add(e3);
			t3.add(e4);
			...
			Employee3 e1 = new Employee3(10454, "Hema", "ECE",500);
			Employee3 e2 = new Employee3(15545, "Mahe", "ece", 400);
			Employee3 e3 = new Employee3(12232, "madu", "cse", 300);
			Employee3 e4 = new Employee3(11323, "hema", "eee", 200);
			t4.add(e1);
			t4.add(e2);
			t4.add(e3);
			t4.add(e4);
