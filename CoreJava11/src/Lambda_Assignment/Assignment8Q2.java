...
public class Assignment8Q2 {
	...
	public static ArrayList<Assignment8Q2> listOfOrders(ArrayList<Assignment8Q2> orders)
	{
		...
		ArrayList<Assignment8Q2> filtered_data = orders.stream().filter(p -> p.totalPrice > 10000)
	...
	{
		ArrayList<Assignment8Q2> ordersArrayList = new ArrayList<Assignment8Q2>(
				Arrays.asList(new Assignment8Q2(11000, "COMPLETED"), new Assignment8Q2(8000, "COMPLETED"),
						new Assignment8Q2(12000, "ACCEPTED")));
